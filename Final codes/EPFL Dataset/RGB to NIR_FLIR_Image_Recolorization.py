...
cv2.imwrite('/home/netrunner/Desktop/Raks/val_256/458_c_rescalexddd.tiff',img3)
...
# model.fit(img_array, img_array2, epochs = 1, batch_size = 10, validation_split=0.1, shuffle = True, verbose = 1)
